...
Avant toute choses, vérifiez que vous avez configuré votre clef ssh et que vous avez copier votre clef publique ( ~/.ssh/id_rsa.pub) dans votre contre gitHub
