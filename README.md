...
Ensure to have ssh keys for authentication set up in ~/.ssh/id_rsa.pub
Ensure to have ssh keys for authentication set up in ~/.ssh/id_rsa.pub and saved in git profile
